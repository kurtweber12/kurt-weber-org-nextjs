...
const ProjectsNew = ({ projects }) => {
	return (
		<motion.div
			...
			className="h-screen flex flex-col relative overflow-hidden text-left md:text-left md:flex-row max-w-full px-4 md:px-10 justify-evenly mx-auto items-center"
		>
