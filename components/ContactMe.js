        ...
        <div className="h-screen flex flex-col relative text-center md:text-left md:flex-row max-w-7xl px-10 justify-evenly mx-auto items-center">
            ...
            <div className="flex flex-col space-y-10">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex flex-col space-y-2 md:w-fit mx-auto w-[100%] pt-24">
                        {/* <button className="bg-neutral-800 border text-neutral-500 py-2 px-8 rounded-full transition-all hover:border-[#f7ab0a]/40 hover:text-[#f7ab0a]/40 hover:bg-transparent"> */}
                        <button className="goToTopButton">
